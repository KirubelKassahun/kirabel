    ...
    >
      <div className="md:col-span-1">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/KirubelKassahun" target="_blank">
            <Image src={GithubIcon} alt="Github Icon" width={40} height={40} />
          </Link>
          <Link
            href="https://www.linkedin.com/in/kirubelkassahun/"
            target="_blank"
          >
            <Image
              src={LinkedinIcon}
      ...
      <div className="md:col-span-1">
        ...
        >
          <div className="mt-12 lg:mt-0">
            <img
              alt="lorem picsum"
              src="https://media.giphy.com/media/ZVik7pBtu9dNS/giphy.gif?cid=790b7611jz6zs0t4divyipfgnom3pfref81xfcoaambb0gra&ep=v1_gifs_search&rid=giphy.gif&ct=g"
              height={500}
